/**
 * Audriusholding AS - Main JavaScript
...
(function() {
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.service-card, .value-card, .project-card, .testimonial-card, .why-item, .process-step');
    ...
    function init() {
        ...
        console.log('Audriusholding AS website initialized');
    }
